#!/bin/bash
# upload-to-zenodo.sh
# Automated Zenodo upload using REST API
#
# Usage: ./upload-to-zenodo.sh [--sandbox]
#
...
config_file="zenodo-upload/zenodo-config.txt"
...
echo ""
echo "Next steps:"
echo "  1. Update R/zenodo.R with the DOIs and URLs above"
