...
* Fix workflow validation issues and YAML syntax errors
* Limit GitHub Actions to only main branch
...
* **New Zenodo record with verified correct data**
  - Deployed new Zenodo record [10.5281/zenodo.17656637](https://zenodo.org/records/17656637)
  ...
  - **Impact**: Ensures users download validated, correct data for all 4 datasets
