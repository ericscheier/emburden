...
**NEW**: Data downloads automatically from OpenEI on first use! No
...
The package automatically downloads LEAD Tool data from OpenEI on first
use and caches it locally for fast subsequent access. No manual data
setup required!

**NEW in v0.3.0**: Support for both 2018 and 2022 LEAD Tool data
vintages enables temporal analysis.
